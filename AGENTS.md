...
This repo is the **single source of truth** — a new Codex session on a new machine has NO prior
memory (the old `~/.Codex` memory does not transfer); everything needed is in git: this file +
