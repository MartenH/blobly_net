...
- **CAN / CAN-FD** — SocketCAN on Linux; PCAN, Kvaser and Vector XL on Windows (see the
  ...
  (`vector:1@500000/2000000` — the data rate in the address is what asks for it); PCAN and
  Kvaser refuse an FD frame rather than truncating it.
...
| CAN-FD | PCAN ✅ · Kvaser Leaf Light v2 is classic-only | **Vector ✅** `vector:1@500000/2000000` (HW-verified to an 8 Mbit/s data phase) · PCAN and Kvaser refuse FD rather than truncating |
